...
#%%
process_dir(idx_tr, f'./mds_unigram_{vocab_size}/tr/') # 11089
process_dir(idx_va, f'./mds_unigram_{vocab_size}/va/') # 11089
process_dir(idx_te, f'./mds_unigram_{vocab_size}/te/') # 11089
